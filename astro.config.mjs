...
export default defineConfig({
  ...
  integrations: [starlight({
      ...
      sidebar: [
        ...
        { label: 'Data Structures', collapsed: true, items: [{ autogenerate: { directory: 'data-structures' } }] },
        { label: 'OOP & the Data Model', collapsed: true, items: [{ autogenerate: { directory: 'oop-data-model' } }] },
        { label: 'Functions In Depth', collapsed: true, items: [{ autogenerate: { directory: 'functions-deep' } }] },
        { label: 'Typing & Errors', collapsed: true, items: [{ autogenerate: { directory: 'typing-errors' } }] },
        { label: 'Async & Concurrency', collapsed: true, items: [{ autogenerate: { directory: 'async-concurrency' } }] },
        { label: 'Stdlib, Testing & Tooling', collapsed: true, items: [{ autogenerate: { directory: 'stdlib-testing-tooling' } }] },
      ],
      }), preact()],
});