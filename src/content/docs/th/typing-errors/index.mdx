...
ตอน runtime Python ไม่ตรวจสอบหรือบังคับใช้ type hints เลย คุณสามารถส่ง string ไปยังพารามิเตอร์ที่ annotate ว่า `int` และ Python จะไม่ร้องเรียน — จะรันโค้ดตามปกติกับค่านั้น ใช้ mypy หรือ pyright เป็น step แยกต่างหากเพื่อดัก type error ก่อนที่จะกลายเป็น bug ในโปรดักชัน
</Callout>
